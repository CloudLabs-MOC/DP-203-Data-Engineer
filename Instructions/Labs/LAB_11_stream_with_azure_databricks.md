...
1. If you do not currently have your **Azure Databricks workspace** open in the Azure portal, navigate to your **resource group** and select deployed Azure Databricks workspace and select **Launch Workspace**.
